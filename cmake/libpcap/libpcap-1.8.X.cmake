...
if (MSVC_VERSION LESS 1700)
    message("visual studio 10 or older not supported")
    return ()
endif()
...
if( HAVE_REMOTE )
    set(PROJECT_SOURCE_LIST_C ${PROJECT_SOURCE_LIST_C}
        pcap-new.c pcap-remote.c sockutils.c)
endif( HAVE_REMOTE )
...
configure_file(${CMAKE_CURRENT_SOURCE_DIR}/pcap_version.h.in ${CMAKE_CURRENT_SOURCE_DIR}/pcap_version.h)
